...
> **This repo** ([jebat8101/Ghunt-v2.2](https://github.com/jebat8101/Ghunt-v2.2)) extends **GHunt v2.2.0** with Python 3.13 compatibility (Pillow, `GHuntCreds`/`autoslot`), optional **Streamlit** UI, and `requirements` tweaks. **Original project:** [mxrch/GHunt](https://github.com/mxrch/GHunt).
...
Features :
- Web Apps & CLI usage and modules
- Python library usage
- Fully async
- JSON export
- Browser extension to ease login
- Optional **Streamlit** UI: `pip install -r requirements-streamlit.txt` then `streamlit run streamlit_app.py`
...
# ⚙️ Installation
 ...
 Run
 $ streamlit run main.py or streamlit_app.py
